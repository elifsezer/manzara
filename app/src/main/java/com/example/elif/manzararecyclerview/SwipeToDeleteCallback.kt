...
abstract class SwipeToDeleteCallback(context: Context):ItemTouchHelper.SimpleCallback(0,ItemTouchHelper.LEFT or ItemTouchHelper.RIGHT) {
    ...
    var backgroundColor= Color.parseColor("#dd4108")
    var clearPaint=Paint().apply { xfermode= PorterDuffXfermode(PorterDuff.Mode.CLEAR)}

    override fun getMovementFlags(recyclerView: RecyclerView, viewHolder: RecyclerView.ViewHolder): Int {
     /*   if (viewHolder?.adapterPosition==null) return 0*/
